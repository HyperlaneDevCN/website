...
转移 Warp 路由所有权的最快方法之一是使用 [Hyperlane CLI](https://hyperlanedevcn.github.io/website/docs/reference/cli)。

<PrerequisitesPartial />

:::info
如果您遵循了 [部署 Warp 路由](https://hyperlanedevcn.github.io/website/docs/guides/deploy-warp-route) 指南，您可能已经使用单个私钥设置了所有者来部署 Warp 路由。在生产环境中，建议使用多签名钱包。
:::
