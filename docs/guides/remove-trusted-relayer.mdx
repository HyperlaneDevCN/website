...
为了进入生产环境，您需要使用 [Hyperlane CLI](https://hyperlanedevcn.github.io/website/docs/reference/cli) 移除此 ISM。

<PrerequisitesPartial />

:::info
如果您遵循了 [部署 Warp 路由](https://hyperlanedevcn.github.io/website/docs/guides/deploy-warp-route) 指南，您很可能已经部署了一个受信任的中继器设置为签名者地址的 Warp 路由。
:::
