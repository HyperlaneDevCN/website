...
Hyperlane代理收集系统活动的有用信息，包括所有消息。这些数据可以通过API进行查询。这些API目前免费提供，无需任何身份验证。连接您首选的GraphQL客户端或库到[https://api.hyperlane.xyz/v1/graphql](https://api.hyperlane.xyz/v1/graphql)即可查询数据！
